        ...
        synchronized (this.pendingSockets) {
            ...
            synchronized (this.pendingData) {
                ...
                if (buffer == null) {
                    ...
                    //Log.e("AbstractPacketWorker", "Buffer in queue null, received data size " + count + " allocated size " + size + " bytes, remaining in buffer: " + buffer.remaining() + " bytes");
                }


                if (count > buffer.remaining()) {
                    int diff = count - buffer.remaining();
                    //Log.e("AbstractPacketWorker", "Buffer need resizing, remaining " + buffer.remaining() + " bytes, needed " + count + " difference " + diff);
