...
public class UserResultsPeriodicWorker extends BaseWorker {
    public UserResultsPeriodicWorker(Context appContext, WorkerParameters workerParams) {
        super(appContext, workerParams);
    }

    public final static String TAG = BaseWorker.PREFIX + "RESULTS";
    ...
    @Keep
    private final static long FLEX_INTERVAL = 1L;
    @Keep
    private final static long BACKOFF_INTERVAL = 30;

    public static void schedulePeriodic(Context context) {
        schedule(context, TAG, UserResultsPeriodicWorker.class, null,
