...
public class NewUserRequest extends Request {
    ...
    public NewUserRequest(ResponseListener responseListener) {
        super(responseListener);
        NewUserPacket nup = new NewUserPacket(networkManager.getClient(), networkManager.getClient().getSocket());
        nup.setPacketIndex((short) 1);
