 ...
 * @since 0.1
 */
public class UserScansAdapter extends FragmentStateAdapter {
    UserScansAdapter(Fragment fragment) {
        super(fragment);
    }
    ...
    public Fragment createFragment(int position) {
        UserScansPageFragment fragment = null;
        switch (position){
            case 0: {
                fragment = UserScansPageFragment.newInstance(ScanLocationPageType.OK);
                break;
            }
            case 1: {
                fragment = UserScansPageFragment.newInstance(ScanLocationPageType.CONTACT);
                break;
            }
        }
        return fragment;
