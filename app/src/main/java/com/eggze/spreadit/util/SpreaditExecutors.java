 ...
 * webservice requests).
 *
 * Implementation from https://github.com/android/architecture-components-samples
 *
 ...
 */
@Singleton
public class SpreaditExecutors {

    private Executor diskIO = null;
    private Executor networkIO = null;
    private Executor mainThread = null;

    public static SpreaditExecutors instance;
    @Inject
    public SpreaditExecutors() {
