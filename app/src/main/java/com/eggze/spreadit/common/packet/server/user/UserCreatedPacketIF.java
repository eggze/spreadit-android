...
/**
 * An interface describing the UserCreatedPacket, a sub-class of the
 * ServerHelloPacket. It contains a fresh userUUID for new users.
 * 
 * @author K. Dermitzakis <kde at eggze.com>
 * @version 0.1
 * @since 0.1
 */
public interface UserCreatedPacketIF extends ServerHelloPacketIF{
