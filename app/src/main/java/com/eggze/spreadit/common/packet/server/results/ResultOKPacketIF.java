 ...
 * receipt of a scan of a Test-QR by a user. If the Test-QR has already been
 * received and exists in the database, a ServerErrorPacket is sent instead.
 * 
 * @author K. Dermitzakis <kde at eggze.com>
 * @version 0.1
 * @since 0.1
 */
public interface ResultOKPacketIF extends ServerPacketIF{
