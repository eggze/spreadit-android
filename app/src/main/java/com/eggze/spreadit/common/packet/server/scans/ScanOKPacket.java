 ...
 * @since 0.1
 */
public class ScanOKPacket extends ServerPacket implements ScanOKPacketIF {

    public ScanOKPacket(SenderIF sender, SocketIF socket) {
        super(sender, socket);
    }
    ...
    public ByteBuffer toBytes() {
        ...
        bytes[3] = ServerPacketIF.T_SCAN_OK;
    ...
    public byte getServerPacketType() {
        return ServerPacketIF.T_SCAN_OK;
    }

    public static void main(String[] args) {
        ScanOKPacket nup = new ScanOKPacket(null, null);


        ScanOKPacket nup2 = new ScanOKPacket(null, null);
