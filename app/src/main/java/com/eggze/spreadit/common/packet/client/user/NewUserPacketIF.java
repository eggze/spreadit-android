...
/**
 * An interface describing the client packet where a new user requests a new
 * userUUID from the UserManager. A new userUUID is provided via a
 * UserCreatedPacket from the UserManager.
 * 
 * @author K. Dermitzakis <kde at eggze.com>
 * @version 0.1
 * @since 0.1
 */
public interface NewUserPacketIF extends ClientPacketIF{
