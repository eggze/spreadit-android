 ...
 * @since 0.1
 */
public class ReqResultsPacket extends ClientPacket implements ReqResultsPacketIF {
    

    public ReqResultsPacket(SenderIF sender, SocketIF socket) {
        super(sender, socket);
    ...
    public ByteBuffer toBytes() {
        ...
        bytes[3] = ClientPacketIF.T_REQ_RESULTS;
    ...
    public byte getClientPacketType() {
        return ClientPacketIF.T_REQ_RESULTS;
    }

    public static void main(String[] args) {
        ReqResultsPacket nup = new ReqResultsPacket(null, null);

        //UUID uuid = UUID.randomUUID();
        //System.out.println("Setting UUID " + uuid);
        //nup.setUserUUID(UUIDUtil.toBytes(uuid));

        ReqResultsPacket nup2 = new ReqResultsPacket(null, null);
